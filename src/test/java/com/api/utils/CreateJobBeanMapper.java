...
public class CreateJobBeanMapper {
	...
	public static CreateJobPayload mapper(CreateJobBean bean)
	{
		...
		int mstWarrentyId=Integer.parseInt(bean.getMst_warrenty_status_id());
		...
		CreateJobPayload payload=new CreateJobPayload(mstServiceLocationId, mstPlatformId,mstWarrentyId,mstOemId, 
				customer, 
				customerAddress, 
				customerProduct, 
				problemList);
